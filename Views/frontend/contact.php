...
if(isset($_POST['contact'])) {
   ...
   $contact->save();
   header('location:index.php?option=Contact1');
}
?>
         ...
         <div class="row">
            ...
            <div class="col-md-6">
               ...
               <div class="mb-3">
                  ...
                  <input type="number" name="phone" id="phone" class="form-control" placeholder="Nhập điện thoại">
               </div>
               <div class="mb-3">
               ...
               <div class="mb-3">
                  <label for="content" class="text-main">Chi tiết</label>
                  <textarea name="content" id="content" class="form-control"
                     placeholder="Nhập nội dung liên hệ"></textarea>
               </div>
               <div class="mb-3">
                  <button name="contact" class="btn btn-main">Gửi liên hệ</button>
               </div>
            </div>
         </div>
      </div>
